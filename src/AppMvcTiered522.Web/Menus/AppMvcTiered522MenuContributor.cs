...
namespace AppMvcTiered522.Web.Menus;

public class AppMvcTiered522MenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public AppMvcTiered522MenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<AppMvcTiered522Resource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                AppMvcTiered522Menus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
